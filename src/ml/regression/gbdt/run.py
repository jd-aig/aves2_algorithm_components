...
parser.add_argument("--loss", type=str, default="ls")#huber
...
model = GradientBoostingRegressor(loss=args.loss, n_estimators=args.n_estimators)
model.fit(x_train,y_train)

save_path = os.path.join(args.output_path,'model.m')
joblib.dump(model,save_path)
print("GBDTRegressor train finished.save model in model/output/model.m")
