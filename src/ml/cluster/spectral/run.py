...
parser.add_argument("--affinity", type=str, default='rbf')#nearest_neighbors, precomputed, rbf
...
#model = spectral_clustering(affinity='rbf',n_clusters=args.n_clusters,n_init=args.n_init)
model = SpectralClustering(affinity=args.affinity,n_clusters=args.n_clusters,n_init=args.n_init)
model.fit(x)
