...
from .platform_task import PlatformTask
...
def register_task(name):
    ...
    def register_task_cls(cls):
        ...
        if not issubclass(cls, PlatformTask):
            raise ValueError('Task ({}: {}) must extend PlatformTask'.format(name, cls.__name__))
...
for file in os.listdir(tasks_dir):
    ...
    if (
        ...
        importlib.import_module('PlatformNlp.tasks.' + task_name)
