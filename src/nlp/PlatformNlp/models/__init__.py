...
def register_model(name):
    ...
    def register_model_cls(cls):
        ...
        if not issubclass(cls, PlatformModel):
            raise ValueError('Model ({}: {}) must extend PlatformModel'.format(name, cls.__name__))
...
for file in os.listdir(models_dir):
    ...
    if (
        ...
        module = importlib.import_module('PlatformNlp.models.' + model_name)
