...
parser.add_argument('--data_folder', type=str, default = '/export/weixue/easy-dl/ocr/public_dataset/MSRA-TD500/train/')
parser.add_argument('--output', type=str, default = '/export/weixue/easy-dl/ocr/text_detection_ctpn_banjin_dev/train_data/')
...
#DATA_FOLDER = "/export/weixue/easy-dl/ocr/public_dataset/MSRA-TD500/train/"
#OUTPUT = "/export/weixue/easy-dl/ocr/text-detection-ctpn-banjin-dev/data/dataset/mlt_new/"
MAX_LEN = 1200
MIN_LEN = 600
