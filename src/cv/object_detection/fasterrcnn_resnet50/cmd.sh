...
CONFIG_FILE="faster_rcnn_resnet50_coco.config"
...
decay_steps_1="@decay_steps_1@"
learing_rate_1="@learning_rate_1@"
decay_steps_2="@decay_steps_2@"
learing_rate_2="@learning_rate_2@"
...
sed -i "s:#${feature_extractor}#:faster_rcnn_resnet50:g" ${CONFIG_FILE}

num_classes_val=20
learning_rate_val_1=0.0003
learning_rate_val_2=0.00003
decay_steps_val_1=20000
decay_steps_val_2=40000
...
python cal_params.py --data_dir ${run_map['tfrecords']} --epochs ${run_map["epochs"]} --batch_size ${batch_size_val} --learning_rate ${run_map['learning_rate']}
i=0
...
do
    ...
    case $i in
        ...
        ;;
        1)
        decay_steps_val_1=$line
        echo "i == 1"
        echo ${decay_steps_val_1}
        ;;
        2)
        decay_steps_val_2=$line
        echo "i == 2"
        echo ${decay_steps_val_2}
        ;;
        3)
        ...
        ;;
        5)
        learning_rate_val_1=$line
        echo "i == 5"
        echo ${learning_rate_val_1}
        ;;
        6)
        learning_rate_val_2=$line
        echo "i == 6"
        echo ${learning_rate_val_2}
        ;;
    esac
    let i+=1
done
...
sed -i "s:${learing_rate_1}:${learning_rate_val_1}:g" ${CONFIG_FILE}
sed -i "s:${learing_rate_2}:${learning_rate_val_2}:g" ${CONFIG_FILE}
sed -i "s:${decay_steps_1}:${decay_steps_val_1}:g" ${CONFIG_FILE}
sed -i "s:${decay_steps_2}:${decay_steps_val_2}:g" ${CONFIG_FILE}
