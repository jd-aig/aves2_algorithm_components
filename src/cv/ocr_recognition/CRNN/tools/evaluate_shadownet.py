...
def init_args():
    ...
    parser.add_argument('-w', '--model_save_dir', type=str, required=True,
                ...
                for epoch in range(num_iterations):
                    test_predictions_value, test_images_value, test_labels_value, \
                     test_images_paths_value = sess.run(
                        [test_decoded, test_images, test_labels, test_images_paths],feed_dict={is_training_flag: True})
...
if __name__ == '__main__':
    ...
    weights_path = tf.train.latest_checkpoint(args.model_save_dir)
